...
var qligentPlayerSettings = {
    ...
    registerLoadCallback: function(playerId, callback) {
        loadCallbacks[playerId] = callback;
    },
    unregisterLoadCallback: function(playerId) {
        loadCallbacks[playerId] = undefined;
    },
	...
	handlers : {
		...
		loadHandler : function(playerId) {
			if (loadCallbacks[playerId]) {
                loadCallbacks[playerId]();
            }
...
module.exports = qligentPlayerSettings;