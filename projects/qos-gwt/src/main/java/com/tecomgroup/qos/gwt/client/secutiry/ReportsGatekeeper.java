...
public class ReportsGatekeeper extends BaseGatekeeper{

	public static List<UISubject> pages = Arrays.asList(PermissionScope.REPORTS);

	@Inject
	public ReportsGatekeeper(final CurrentUser currentUser) {
		super(currentUser);
	}
