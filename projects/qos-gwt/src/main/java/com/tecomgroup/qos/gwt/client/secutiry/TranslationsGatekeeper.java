...
public class TranslationsGatekeeper extends BaseGatekeeper{

	public static List<UISubject> pages = Arrays.asList(PermissionScope.LIVE_VIDEO);

	@Inject
	public TranslationsGatekeeper(final CurrentUser currentUser) {
		super(currentUser);
	}
