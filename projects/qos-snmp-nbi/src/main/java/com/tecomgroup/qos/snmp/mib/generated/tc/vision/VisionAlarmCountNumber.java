...
/**
 * Textual convention VisionAlarmCountNumber from QLIGENT-VISION-MIB.
 * 
 ...
 * 
 */
public class VisionAlarmCountNumber implements TextualConvention<Variable> {

	private static final String TC_VISIONALARMCOUNTNUMBER = "VisionAlarmCountNumber";

	private final MOFactory moFactory;

	public VisionAlarmCountNumber(final MOFactory moFactory) {
	...
	public String getName() {
		return TC_VISIONALARMCOUNTNUMBER;
	}
}